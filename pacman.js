...
//only going to change a parameter to complete this part -per shaker kattoula
function Run() {
...
//you can get help with this by simply searching online for the proper syntax etc. 
// This function determines the direction of PacMan based on screen edge detection. 
function checkPageBounds(direction, imgWidth, pos, pageWidth) {
  //
  // TODO: Complete this to reverse direction upon hitting screen edge
  //
  if (pos > pageWidth && direction === 0) {
    return direction = 1
